 ...
 * @author Cheng Wei
 */
public class WidgetViewAttributeProviderAdapter<T extends View>
{
	private WidgetViewAttributeProvider<T> widgetViewAttributeProvider;
	public WidgetViewAttributeProviderAdapter(WidgetViewAttributeProvider<T> widgetViewAttributeProvider)
	{
