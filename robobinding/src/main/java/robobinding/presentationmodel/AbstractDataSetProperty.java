...
import robobinding.beans.AbstractProperty;
...
public abstract class AbstractDataSetProperty<T> extends AbstractProperty<Object>
{
	...
	{
		robobinding.beans.ItemPresentationModel annotation = propertyAccessor.getAnnotation(robobinding.beans.ItemPresentationModel.class);
