...
https://github.com/depoll/bindroid[Bindroid]. We value *code quality* and RoboBinding comes with more than 300 unit tests, which makes difference. We value and love to hear *any voices(negtive or positive) or suggestions* and invite you to post into our http://groups.google.com/group/robobinding[Google group].
