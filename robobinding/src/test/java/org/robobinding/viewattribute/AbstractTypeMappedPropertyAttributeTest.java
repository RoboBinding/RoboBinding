...
public abstract class AbstractTypeMappedPropertyAttributeTest<IT, VST>
{
	...
	protected static class TypeMappedBindingSamples<IT, VST> extends AbstractBindingExpectations<IT, VST>
	{
		public void addMapping(IT inputValue, VST expectedViewState)
		{
			bindingExpectations.add(new BindingExpectation<IT, VST>(inputValue, expectedViewState));
		}
	}
	
	protected static class BindingSamples<IT> extends AbstractBindingExpectations<IT, IT>
	{
		public void add(IT... samples)
		{
