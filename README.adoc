...
We value and love to hear *any voices(negtive or positive) or suggestions* and invite you to post into our http://groups.google.com/group/robobinding[Google group].
...
* link:http://robobinding.org/versions.html[Versions]
