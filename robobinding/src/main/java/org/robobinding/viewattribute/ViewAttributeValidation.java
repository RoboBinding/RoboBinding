...
public class ViewAttributeValidation
{
	...
	void addErrorIfPropertyAttributeValueNotSet(ValueModelAttributeValue attributeValue)
	{
	...
	void addErrorIfCommandNameNotSet(CommandAttributeValue attributeValue)
	{
