...
Let's link:getting_started.html[get started].

Similar Presentation Model/MVC/MVP/http://en.wikipedia.org/wiki/Model_View_ViewModel[MVVP] frameworks for android: https://github.com/gueei/AndroidBinding[Android-Binding],
