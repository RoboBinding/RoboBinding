...
public class BinderFactory {
	...
	public ViewBinder createViewBinder(Context context,
			boolean withPreInitializingViews) {
		checkContext(context);

		SingleInstanceCreator creator = new SingleInstanceCreator(
				viewListenersMap, bindingAttributeMappingsProviderMap, context,
				withPreInitializingViews);
	...
	public MenuBinder createMenuBinder(Menu menu, MenuInflater menuInflater,
			Context context) {
    ...
    private static class SingleInstanceCreator {
		...
		public SingleInstanceCreator(ViewListenersMap viewListenersMap, 
			BindingAttributeMappingsProviderMap bindingAttributeMappingsProviderMap, 
			Context context,
			boolean withPreInitializingViews) {
		    this.viewListenersMap = viewListenersMap;
		...
		public MenuBinder createMenuBinder(MenuInflater menuInflater, Menu menu) {
		    ...
		    BindingMenuInflater bindingMenuInflater = new BindingMenuInflater(context, menu, menuInflater, bindingAttributeParser,
