...
public class MockPresentationModelAdapterBuilder {
    ...
    private <PropertyType> MockPresentationModelAdapterBuilder declareReadOnlyProperty(String propertyName,
	    ValueModel<PropertyType> propertyValueModel) {
    ...
    private <PropertyType> MockPresentationModelAdapterBuilder declareProperty(String propertyName,
	    ValueModel<PropertyType> propertyValueModel) {
