...
{
	private BooleanHeaderOrFooterVisibilityAttribute attribute;
	...
	public void setUp()
	{
		...
		attribute = subViewVisibilityAttribute.new BooleanHeaderOrFooterVisibilityAttribute();
	}
	...
	public void whenValueModelUpdated_thenVisibilityStateUpdatedAccordingly()
	{
		...
		assertEquals(newValue?View.VISIBLE:View.GONE, mockSubViewVisibility.state);
	}
}
