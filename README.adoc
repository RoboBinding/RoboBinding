...
https://github.com/depoll/bindroid[Bindroid]. You may notice RoboBinding has much *better code quality*. We value code quality and RoboBinding comes with more than 300 unit tests.
...
* link:https://oss.sonatype.org/service/local/repositories/releases/archive/org/robobinding/robobinding/0.8.3/robobinding-0.8.3-javadoc.jar/!/index.html[API and Binding Attributes JavaDocs]
