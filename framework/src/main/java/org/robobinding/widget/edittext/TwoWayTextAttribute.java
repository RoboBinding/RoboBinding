...
public class TwoWayTextAttribute implements MultiTypePropertyViewAttribute<EditText> {
    ...
    private abstract static class AbstractTwoWayCharSequenceTextAttribute<PropertyType extends CharSequence>
    	implements TwoWayPropertyViewAttribute<EditText, PropertyType> {
