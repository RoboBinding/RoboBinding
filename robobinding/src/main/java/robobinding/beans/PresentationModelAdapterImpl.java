...
public class PresentationModelAdapterImpl implements PresentationModelAdapter
{
	 ...
	 */
	public PresentationModelAdapterImpl(Object bean)
	{
	...
	{
		Object oldBean = this.presentationModel;
		this.presentationModel = bean;
	...
	private <P> PropertyAdapter<B, P> createPropertyAdapter(String propertyName, String readMethodName, String writeMethodName)
	{
		...
		builder.setBean(presentationModel);
	...
	public void release()
	{
		removeChangeHandlerFrom(presentationModel);
	...
	private void forwardAllAdaptedValuesChanged()
	{
		...
		{
			property.setBean(presentationModel);
		}
	}
	...
	public Class<?> getPropertyType(String attributeValue)
	{
