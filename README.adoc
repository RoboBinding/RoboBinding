...
* link:https://oss.sonatype.org/service/local/repositories/snapshots/archive/org/robobinding/robobinding/0.8.2-SNAPSHOT/robobinding-0.8.2-20140504.055736-699-javadoc.jar/!/index.html[API and Binding Attributes JavaDocs]
