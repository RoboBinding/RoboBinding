...
class CustomBindingAttributeMappingsImpl<T extends View> extends BindingAttributeMappingsImpl<T> implements CustomBindingAttributeMappings<T> {
    ...
    @Override
    public <S extends View> void mapPropertyAttribute(S alternateView,
	    Class<? extends PropertyViewAttribute<? extends View>> propertyViewAttributeClass, String attributeName) {
    ...
    @Override
    public <S extends View> void mapCommandAttribute(S alternateView,
    ...
    @Override
    public <S extends View> void mapGroupedAttribute(S alternateView,
