...
public class PropertyFactoryTest {
	...
	public void whenCreateListDataSetProperty_thenReturnCorrectInstance() {
		AbstractDataSetProperty dataSetProperty = propertyFactory.createDataSetProperty(aPropertyAccessor().withAnnotation(ItemPresentationModel.class, true)
				.withPropertyType(List.class).build());
	...
	public void whenCreateArrayDataSetProperty_thenReturnCorrectInstance() {
		AbstractDataSetProperty dataSetProperty = propertyFactory.createDataSetProperty(aPropertyAccessor().withAnnotation(ItemPresentationModel.class, true)
				.withPropertyType(Object[].class).build());
	...
	public void whenCreateCursorDataSetProperty_thenReturnInstance() {
		AbstractDataSetProperty dataSetProperty = propertyFactory.createDataSetProperty(aPropertyAccessor().withAnnotation(ItemPresentationModel.class, true)
				.withPropertyType(TypedCursor.class).build());
	...
	public void whenCreateUnsupportedDataSetProperty_thenThrowException() {
		...
		propertyFactory.createDataSetProperty(aPropertyAccessor().withAnnotation(ItemPresentationModel.class, true).withPropertyType(unsupportedDataSetType)
				.build());
	}

	@Test(expected = RuntimeException.class)
	public void whenCreateDataSetPropertyWithoutItemPresentationModelAnnotation_thenThrowException() {
		propertyFactory.createDataSetProperty(aPropertyAccessor().withAnnotation(ItemPresentationModel.class, false).build());
	}
}
