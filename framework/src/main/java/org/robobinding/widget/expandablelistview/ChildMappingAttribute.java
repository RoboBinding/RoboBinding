 ...
 * @author Jihun Lee
 */
public class ChildMappingAttribute implements ChildViewAttributeWithAttribute<PredefinedMappingsAttribute> {
	private final PredefinedMappingUpdater predefinedMappingsUpdater;
	private PredefinedMappingsAttribute mappingsAttribute;

	public ChildMappingAttribute(PredefinedMappingUpdater predefinedMappingsUpdater) {
