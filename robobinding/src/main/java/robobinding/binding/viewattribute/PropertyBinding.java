...
public class PropertyBinding
{
	...
	public PropertyBinding(String attributeValue)
	{
		PropertyAttributeEvaluator attributeEvaluator = new PropertyAttributeEvaluator(attributeValue);
		propertyName = attributeEvaluator.determinePropertyName();
		twoWayBinding = attributeEvaluator.isTwoWayBinding();
	}
	
	private static class PropertyAttributeEvaluator
	{
