 ...
 *
 */
public class PresentationModelInfoBuilder1 extends AbstractPresentationModelInfoBuilder1 {
	private static final String ITEM_PRESENTATION_MODEL_OBJECT_SUFFIX = "$$IPM";
	public PresentationModelInfoBuilder1(Class<?> presentationModelClass, String presentationModelObjectTypeName) {
	...
	public void buildProperties() {
		...
		for(PropertyDescriptor descriptor : descriptors) {
			if(isDataSetProperty(descriptor)) {
				...
				dataSetProperties.add(new DataSetPropertyInfoForTest(descriptor, itemPresentationModelAnnotation, 
