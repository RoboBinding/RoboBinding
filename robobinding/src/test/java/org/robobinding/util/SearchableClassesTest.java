...
public class SearchableClassesTest {
    ...
    @Before
    public void setUp() {
	searchableClasses = new SearchableClasses(Sets.<Class<?>>newHashSet(
		GrandparentClazz.class,
		GrandparentSuperInterface.class,
		Clazz.class,
	...
	assertThat(searchableClasses.findNearestAssignableFrom(Clazz.class), 
		sameInstance((Class) Clazz.class));
	
	assertThat(searchableClasses.findNearestAssignableFrom(UnregisteredParentClazz.class), 
		sameInstance((Class) GrandparentSuperInterface.class));
	
	assertThat(searchableClasses.findNearestAssignableFrom(UnregisteredGrandparentInterface.class), 
		sameInstance((Class) GrandparentSuperInterface.class));
    }
	...
	Queue<Class<?>> expectedAssignablesInOrder = Lists.newLinkedList(Lists.newArrayList(
		Clazz.class, 
		ParentInterface.class,
		GrandparentSuperInterface.class,
		GrandparentClazz.class));
